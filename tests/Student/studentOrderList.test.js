...
describe("Student can list their orders", () => {
    ...
    test("It is not able to retrive from dynamodb", async () => {
        const orderDetails = [
            {
                userId: "63f70088-2218-4a03-a206-48f576a553c3",
                orderId: "39c015d0-1e44-11e9-ab86-fb4cb32fd6ad",
                studentNumber: "dbdmpo001",
                name: "Mpodumo Doubada",
                email: "mkdoubada@gmail.com",
              ...
              {
                userId: "63f70088-2218-4a03-a206-48f576a553c4",
                orderId: "8dc1ab80-1e44-11e9-ab86-fb4cb32fd6ad",
                studentNumber: "dbdmpo001",
                name: "Mpodumo Doubada",
                email: "mkdoubada@gmail.com",
              ...
              {
                userId: "6f1d9b77-2843-4b0b-b8bb-eb8a877f80a2",
                orderId: "02c7a6b0-17e1-11e9-8afc-3507af94e477",
                studentNumber: "123456",
                name: "Thanos-Titain",
                email: "thanos@example.com",
              ...
              {
                userId: "6f1d9b77-2843-4b0b-b8bb-eb8a877f80a",
                orderId: "032db310-18b3-11e9-a394-53f8bded1d33",
                studentNumber: "123456",
                name: "Thanos-Titain",
                email: "thanos@example.com",
        ...
        expect(orderDetails[0].userId).not.toBe("6f1d9b77-2843-4b0b-b8bb-eb8a877f80a8");
        expect(orderDetails[1].userId).not.toBe("6f1d9b77-2843-4b0b-b8bb-eb8a877f80a8");
        expect(orderDetails[2].userId).not.toBe("6f1d9b77-2843-4b0b-b8bb-eb8a877f80a8");
